...
train/test splits. IDS<sup>2</sup>Eval runs 23 checks that catch these
...
| [guide/checks.md](guide/checks.md) | What each of the 23 checks does, and the research behind it |
