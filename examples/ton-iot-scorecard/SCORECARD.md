...
**Dataset:** ton-iot
**Overall status:** ❌ Failed, 9 ok, 2 warning(s), 2 flag(s)
**Generated:** 2026-09-26T09:31:25.064516+00:00
...
| 3 | `leakage_screen` | ✅ pass | ✅ pass | *Evidence: statistical.* no single feature or pair dominates importance (top1=9.4%, top2=17.4%) |
| 4 | `one_rule_check` | ✅ pass | ✅ pass | *Evidence: statistical.* single rule 'L4_DST_PORT <= 443.5' reaches 40.3% test accuracy (40.4% train) |
| 5 | `identity_column_flag` | 🚩 flag | 🚩 flag | *Evidence: statistical.* standalone AUC by column: {'L4_DST_PORT': 0.896}. Suggest dropping: ['L4_DST_PORT'] |
| 6 | `temporal_leakage_check` | ✅ pass | ✅ pass | *Evidence: statistical.* no schema.timestamp_column configured |
| 7 | `homogeneity_test` | 🚩 flag | 🚩 flag | *Evidence: statistical.* 10 classes tested; leakage signature (test significantly closer than control, p<0.05) in: ['dos', 'backdoor'] |
| 8 | `class_distribution_report` | ⚠️ warn | ⚠️ warn | *Evidence: statistical.* 10 classes, train imbalance ratio (majority:minority) = 1177:1; classes below 1% of train: ['backdoor', 'mitm', 'ransomware'] |
| 9 | `low_cardinality_warning` | ✅ pass | ✅ pass | *Evidence: statistical.* unique values by column: {'L4_DST_PORT': 49397} |
| 10 | `data_integrity_check` | ⚠️ warn | ⚠️ warn | *Evidence: statistical.* +-inf values in 2 feature column(s) |
| 11 | `near_duplicate_class_check` | ✅ pass | ✅ pass | *Evidence: statistical.* no near-zero-distance feature vectors found across 10 classes tested |
...
> This result was obtained on a dataset audited with IDS2Eval v0.1.0 (scorecard schema 1.2), which reported failed, 9 ok, 2 warning(s), 2 flag(s) across 13 checks. Full report: audit_report_after.json.
